...
func SeedEvents() error {
	...
	events := []Event{
		...
		// NEW EVENTS - 11+ more to reach 30+
		// PAST EVENTS (August - Early September 2026)
		{
		...
		},
		{
			...
			Slug:          "summer-cinema-under-stars",
			City:          "Austin",
		...
		// CLOSE TO TODAY (September 16-30, 2026)
		{
		...
		// FUTURE EVENTS (October - December 2026)
		{
